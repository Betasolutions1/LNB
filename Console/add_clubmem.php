                 ...
                 <div style="background-color:#fff" class="shdw">
                                            <div class="media  bg" style="background:#afdf7c"> 
                                                ...
                                                <div class="media-body innerTB half bg" style="padding-top:4px;"> 
                                                    ...
                                                    <br>
                                                    <span style="color:#fff;">Clubs</span> 
                                            ...
                                            <select class="form-control" name="club_names" id="club_names" onChange="return showusers(this.value);">	
                                            <option>Select ClubName</option>
                                            <?php
                                            $get_clb=mysqli_query($conn,"select * from tbl_club");
											while($clbs=mysqli_fetch_array($get_clb))
											{
											?>
                                            <option value="<?php echo $clbs['CLUB_ID']?>"><?php echo $clbs['CL_NAME'];?></option>
                                            <?php
											}
											?>
                                            </select>
                                            ...
                                            <div class="form-control" id="txtHint"> 
                                            ...
                                            <div style="border-bottom:5px solid #ADCA8CM; margin-bottom: 10px; float:right;">
                                                <button type="submit" name="" onClick="return ins_clubs();" class="btn btn-success navbar-btn" style="">
                                                    CLUB
</button>
