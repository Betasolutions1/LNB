                 ...
                 <div style="background-color:#fff" class="shdw">
                                            <div class="media  bg" style="background:#afdf7c"> 
                                                ...
                                                <div class="media-body innerTB half bg" style="padding-top:4px;"> 
                                                    ...
                                                    <br>
                                                    <span style="color:#fff;">Help LNBusiness</span> 
                                            ...
                                            <div class="input-group comment"> 
                                                ...
                                                <textarea style="resize:none" class="span12 form-control" name="help_data" id="help_data" cols="90" rows="10" placeholder="ITS LNB Help..."></textarea>
                                            </div>
                                            <div style="border-bottom:5px solid #ADCA8CM; margin-bottom: 10px; float:right;">
                                                <button type="submit" name="sub_post" onClick="return ins_help_Lnb();" class="btn btn-success navbar-btn" style="">
                                                    HELP
</button>
