                ...
                <div class="col-lg-6 col-md-6 "> 
                 <div style="background-color:#fff" class="shdw">
                                            ...
                                            <div class="input-group comment"> 
                                                ...
                                                <textarea style="resize:none" class="span12 form-control" name="trmcon_data" id="trmcon_data" cols="90" rows="10" placeholder="ITS LNB TERMS & CONDITIONS..."></textarea>
                                            </div>
                                            <div style="border-bottom:5px solid #ADCA8CM; margin-bottom: 10px; float:right;">
                                                <button type="submit" name="sub_post" onClick="return ins_terms_condi_Lnb();" class="btn btn-success navbar-btn" style="">
                                                    T & C
</button>
